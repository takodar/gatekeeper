...
<option selected="selected" value="">{_t("Where am I ?")}</option>
    ...
    <span class="codo_switch_off">{_t('No')}</span>-->
                    ...
                    <button id="codo_create_topic_btn" type="submit" class="codo_btn codo_btn_primary codo_create_topic_btn" style="width:100%">{_t("Create new topic")}</button>
                    </div>
                    {/if}
            ...
            <div class="codo_topics_loadmore_div row" id="codo_topics_load_more">
                ...
                {if $can_create_topic}
                    ...
                    <div class="pagination_new_topic col-md-2 col-sm-12">
                        <button id="codo_create_topic_btn" type="submit" class="codo_btn codo_btn_primary codo_create_topic_btn">{_t("Create new topic")}</button>
                    </div>
                {/if}
