...
//                                UserField.style.background = FieldFoundStyle;
    ...
    {
        var nodesArray = [].slice.call(document.querySelectorAll("input[type='password']"));
    ...
    {
        var count = 0,nodesArray = [].slice.call(document.querySelectorAll("input[type='password']"));
        for (var j=0; j < nodesArray.length; j++) {
    ...
    function attachDblClick(inputType)
    {
        ...
        {
            var nodesArray = [].slice.call(document.querySelectorAll("input[type='" +inputType +"']"));
            for (var j=0; j < nodesArray.length; j++) {
...
//            document.cookie="sessionToken=none";
        }
...
//                        document.cookie="sessionToken=" +ret.sessionToken;
                    if(ret.status != 'ok') {
                        alert(ret.status);
                        return false;
                    }
...
//                                        Mode = "login-change";
    ...
    function findInput(type) {
        var inputs, count = 0, form, el, elem, formsList = document.getElementsByTagName("form");
...
//                    console.log("Password Input field not found");
    ...
    {
        var i, container = document.getElementById("tabContainer");
...
//        }
    ...
    function init() {
        var i,
            FrameTest,
            Area;
        Target = (document !== undefined) ? document : false;
        TargetHref =  Target.location.href; // 'http://fake.com';
        TargetWindow = (window !== undefined) ? window : false;
        FrameCount = window.frames.length - document.getElementsByTagName('iframe').length;
...
//            console.log("Using submit id");
            document.getElementById(SubmitInputId).focus();
